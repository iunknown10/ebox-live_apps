package com.eboxlive.ebox.image;
...
import com.eboxlive.ebox.image.ImageLoadManager.Coding;
import com.eboxlive.ebox.util.Handler_System;
	...
	private class BitmapWorkerTask extends AsyncTask<Void, Void, BitmapDrawable> {
		...
		protected void onPostExecute(BitmapDrawable value) {
			...
			if (value != null && imageView != null) {
				...
				{
					if(String.valueOf(imageView.getTag()).equalsIgnoreCase(String.valueOf(mData)))
					{
						finish(value.getBitmap(), imageView, lister);
						Log.e("ImageWorker","Not need to set ImageView!");
						return;
					}
				}
