...
//    private boolean mFullscreenEnabled = false;
    ...
    private static final int HIDE_CENTER=9;
    ...
    private void initControllerView(View v) {
        ...
        centerLayout = (ViewGroup) v.findViewById(R.id.center_layout);
        playTextView=(TextView)v.findViewById(R.id.playTitle);
    ...
    private void hideCenterView(boolean hideCenter) {
    	if(hideCenter)
    	{
	        if (mCenterPlayButton.getVisibility() == VISIBLE) {
	            mCenterPlayButton.setVisibility(GONE);
    ...
    private View.OnClickListener mCenterPlayListener = new View.OnClickListener() {
        public void onClick(View v) 
        {
        	centerLayout.setBackgroundColor(getResources().getColor(R.color.transparent));
            hideCenterView(true);
            mPlayer.start();
            //zhenyubin 2016-02-19
...
//        super.setEnabled(enabled);
    ...
    public void hideLoading(boolean fromPrepare) 
    {
    	if(fromPrepare)
    	{
    		mPlayer.transparentBackgroud();
    		mHandler.sendEmptyMessage(HIDE_CENTER);
    	}
    	else 
    	{
    		mPlayer.transparentBackgroud();
...
//    }
    ...
    public interface MediaPlayerControl {
        ...
        void transparentBackgroud();//点击一次播放按钮后，将背景图片设置为透明
