...
public class UniversalVideoView extends SurfaceView
    ...
    public UniversalVideoView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setBackground(getResources().getDrawable(R.drawable.thumb));
        a.recycle();
        initVideoView();
    }
    ...
    private void openVideo() {
        ...
        try {
        	...
        	mMediaPlayer=getMediaPlayer(getContext());
    ...
    MediaPlayer.OnPreparedListener mPreparedListener = new MediaPlayer.OnPreparedListener() {
        public void onPrepared(MediaPlayer mp) {
            ...
            if (mMediaController != null) {
                mMediaController.hideLoading(true);
            }
...
//                    }
    ...
    @Override
	public void transparentBackgroud() {
